...
export const OpenInChatGPT = (props: Omit<OpenInProviderProps, "provider">) => (
  <OpenInProviderItem provider="chatgpt" {...props} />
);
export const OpenInClaude = (props: Omit<OpenInProviderProps, "provider">) => (
  <OpenInProviderItem provider="claude" {...props} />
);
export const OpenInT3 = (props: Omit<OpenInProviderProps, "provider">) => (
  <OpenInProviderItem provider="t3" {...props} />
);
export const OpenInScira = (props: Omit<OpenInProviderProps, "provider">) => (
  <OpenInProviderItem provider="scira" {...props} />
);
export const OpenInv0 = (props: Omit<OpenInProviderProps, "provider">) => (
  <OpenInProviderItem provider="v0" {...props} />
);
export const OpenInCursor = (props: Omit<OpenInProviderProps, "provider">) => (
