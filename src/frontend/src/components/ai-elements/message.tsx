...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      "group flex w-full max-w-message flex-col gap-2",
...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      "is-user:dark flex w-fit min-w-0 max-w-full flex-col gap-2 overflow-hidden text-[14px]",
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:bg-sidebar group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-foreground",
  ...
  ({ className, children, ...props }: MessageResponseProps) => (
    <Streamdown
      ...
      className={cn(
        ...
        // Headings — allow proper visual hierarchy
        ...
        "[&_h4]:text-[13px] [&_h4]:leading-snug [&_h4]:font-medium [&_h4]:mt-2 [&_h4]:mb-1",
        // Code
        "[&_pre]:overflow-x-auto [&_pre]:rounded-lg [&_pre]:border [&_pre]:border-border-subtle [&_pre]:bg-muted/40 [&_pre]:p-3",
        "[&_code]:font-mono [&_code]:text-[13px] [&_code]:leading-[1.65]",
        // Lists
