...
const resolveSchemaPropertyPaddingClass = (depth: number) =>
  SCHEMA_PROPERTY_PADDING_CLASSES[Math.min(depth, SCHEMA_PROPERTY_PADDING_CLASSES.length - 1)];
...
export const SchemaDisplayProperty = ({
  ...
  return (
    <div
      className={cn("py-3 pr-4", resolveSchemaPropertyPaddingClass(depth), className)}
      {...props}
    >
      <div className="flex items-center gap-2">
