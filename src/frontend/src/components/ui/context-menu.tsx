...
function ContextMenuSubTrigger({
  ...
  return (
    <ContextMenuPrimitive.SubmenuTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-muted data-[state=open]:bg-muted flex cursor-default items-center rounded-sm px-2 py-1.5 outline-hidden select-none data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
  ...
  return (
    <ContextMenuPrimitive.Positioner>
      <ContextMenuPrimitive.Popup
        ...
        className={cn(
          "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[8rem] overflow-hidden rounded-md border border-border-subtle p-1 shadow-lg",
          className,
        )}
        {...props}
      />
...
function ContextMenuItem({
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      onClick={onSelect as unknown as React.MouseEventHandler<HTMLElement>}
      {...props}
    />
  );
}
...
function ContextMenuCheckboxItem({
  ...
  return (
    <ContextMenuPrimitive.CheckboxItem
      ...
      className={cn(
        "focus:bg-muted relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      checked={checked}
      {...props}
...
function ContextMenuLabel({
  ...
  return (
    <ContextMenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn("text-foreground px-2 py-1.5 data-[inset]:pl-8", className)}
      {...props}
    />
  );
}
