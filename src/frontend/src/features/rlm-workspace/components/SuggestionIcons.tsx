...
export function SuggestionIconTune() {
  return <SlidersHorizontal className="size-4 shrink-0 text-muted-foreground" aria-hidden="true" />;
}

/** Sparkle / magic — "Design / imagine" affordance. */
export function SuggestionIconSparkle() {
  return <Sparkles className="size-4 shrink-0 text-muted-foreground" aria-hidden="true" />;
}
