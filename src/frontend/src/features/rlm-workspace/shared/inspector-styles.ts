 ...
 *
 * Usage:
 *   import { inspectorStyles, inspectorInsetClass, inspectorPreviewButtonClass } from "@/features/rlm-workspace/shared/inspector-styles";
 *
...
export const inspectorStyles = {
  ...
  badge: {
    ...
    meta: "rounded-full text-[10px] font-medium",
    /** Standard badge row. */
