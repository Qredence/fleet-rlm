...
import {
  ...
  asRecord,
  parseRuntimeContext,
} from "@/screens/workspace/model/backend-chat-event-payload";
import { attachFinalReferences } from "@/screens/workspace/model/backend-chat-event-references";
import {
  normalizeTrajectorySteps,
  normalizeTrajectoryStepsFromFinalPayload,
  trajectoryStepDetails,
  type NormalizedTrajectoryStep,
} from "@/screens/workspace/model/backend-chat-event-trajectory";
import {
  appendToolLikePart,
  inferStatusTone,
