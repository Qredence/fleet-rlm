...
import { buildChatDisplayItems } from "@/screens/workspace/model/chat-display-items";
import type { ChatRuntime, ChatSubmitOptions } from "@/screens/workspace/model/runtime-types";
...
export function useWorkspaceRuntime(): ChatRuntime {
