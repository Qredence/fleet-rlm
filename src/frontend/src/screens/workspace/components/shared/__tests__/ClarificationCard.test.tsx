...
import { ClarificationCard } from "@/screens/workspace/components/shared/ClarificationCard";
...
describe("ClarificationCard", () => {
  it("reveals a labeled textarea for custom answers and resolves trimmed text", () => {
    ...
    const customOption = Array.from(
      container.querySelectorAll('[data-slot="radio-option-card"]'),
    ).find((button) => button.textContent?.includes("Write your own"));
