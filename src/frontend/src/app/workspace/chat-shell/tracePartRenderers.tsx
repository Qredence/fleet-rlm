...
import {
  ...
  Attachments,
  AttachmentPreview,
} from "@/app/workspace/attachments";
import {
  ChainOfThought,
  ChainOfThoughtContent,
  ChainOfThoughtHeader,
  ChainOfThoughtStep,
} from "@/app/workspace/chain-of-thought";
import {
  Confirmation,
...
} from "@/app/workspace/environment-variables";
import {
  InlineCitation,
  InlineCitationCard,
  ...
  InlineCitationText,
} from "@/app/workspace/inline-citation";
...
import {
  ...
  mapTaskStatus,
  mapToolState,
} from "@/lib/utils/prompt-kit-state";
