# fleet_rlm_clean — Bundled Agent Skills
...
Package data under `fleet_rlm_clean.skills.skills`. Seed into the host registry:
...
Skills must describe `fleet_rlm_clean` only. If a skill references
