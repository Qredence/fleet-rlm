"""DSPy signatures for demo/document-extraction examples.

These signatures power legacy/demo runners and sample extraction tasks. They are
kept separate from production/runtime signatures to make the core execution
