...
if TYPE_CHECKING:
    ...
    from fleet_rlm.rlm.recursion import DelegationMetrics, RecursiveCallSummary, RecursiveRLMExecutor
...
# DSPy callbacks produce Fleet runtime observations; the DSPy program remains the loop owner.
