...
def build_workspace_agent_code(
    *,
    ...
    code = "\n".join(
        (
            "import base64, errno, hashlib, json, os, re, stat, time",
            ...
            "                        if existing is None or effective_memory_id(existing) != candidate_id:",
            "                            continue",
            ...
            "                            respond({'ok': True, 'entry': entry_for(existing_stat, relative)})",
            "                        fail('unsafe')",
            ...
            "                if match is not None and effective_memory_id(match) == memory_id:",
