"""CLI demo and diagnostic commands for DSPy RLM.

This module registers Typer commands for running RLM demonstrations
and diagnostics. Commands are registered on the shared ``app`` instance
via :func:`register_demo_commands`.
...
Demo commands:
    ...
    - run-long-context: Analyze or summarize long documents
...
def register_demo_commands(
    ...
    *,
    ...
    """Register demo and diagnostic CLI commands on *app*."""
    ...
    def run_architecture(
        ...
        if docs_path is None:
            typer.echo(
                "Error: '--docs-path' is required for run-architecture.", err=True
            )
    ...
    def run_trajectory(
        ...
        chars: int = typer.Option(
            3000, help="Number of document characters for sample"
        ),
    ...
    def run_custom_tool(
        ...
        chars: int = typer.Option(
            10000, help="Number of document characters for sample"
        ),
        max_iterations: int = typer.Option(15, help="RLM max_iterations"),
