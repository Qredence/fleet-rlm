...
_RUNTIME_SETTING_DEFINITIONS: tuple[RuntimeSettingDefinition, ...] = (
    ...
    _definition(
        ...
        description="Maximum output tokens for each RLM action-generation call; separate from REPL output truncation.",
        reload_required=True,
        placeholder="2048",
        default="2048",
    ),
    _definition(
        ...
        category="llm",
        label="Planner LM request timeout (s)",
        description="Per-request wall-clock timeout for planner LM calls. Bounds stalled providers so a single slow response can't hold a chat turn.",
        reload_required=True,
        placeholder="60",
        default="60",
    ),
    _definition(
        ...
        category="llm",
        label="Delegate LM request timeout (s)",
        description="Per-request wall-clock timeout for delegate LM calls.",
        reload_required=True,
        placeholder="60",
        default="60",
    ),
    _definition(
        ...
        category="llm",
        label="Planner LM temperature",
        description="Optional sampling temperature for planner LM calls. Leave empty to use the provider/model default.",
        reload_required=True,
        placeholder="0.7",
    ),
    _definition(
