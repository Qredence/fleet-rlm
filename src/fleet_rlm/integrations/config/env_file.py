"""Environment-file discovery, masking, snapshots, and safe updates."""
...
def should_mask_key(key: str) -> bool:
    ...
    definition = RUNTIME_SETTING_INDEX.get(normalized)
...
def get_settings_snapshot(
    *,
    ...
    for category, category_label, category_description in CATEGORY_METADATA:
