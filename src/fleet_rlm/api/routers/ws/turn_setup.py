...
from ...execution import ExecutionEventEmitter, ExecutionStepBuilder
...
from .turn_lifecycle import initialize_turn_lifecycle
from .types import (
    ChatAgentProtocol,
    LocalPersistFn,
    PreStreamSetupFn,
...
async def prepare_chat_message_turn(
    *,
    ...
    if daytona_request is not None:
        ...
        prepare_stream = _prepare_stream
