...
class MemoryItemResponse(BaseModel):
    ...
    scope: str = Field(description="Memory scope (e.g. user, tenant, workspace, run, session).")
    ...
    content_text: str | None = Field(default=None, description="Textual content when available.")
