...
This module implements the init command, which copies bundled RLM skills,
agents, teams, and hooks from the installed fleet-rlm package to the user's
~/.claude/ directory.
"""
...
def init_command(
    ...
    if total_skipped > 0:
        typer.echo(f"  Skipped {total_skipped} existing (use --force to overwrite)")
