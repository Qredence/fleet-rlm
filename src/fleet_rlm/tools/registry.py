...
_TOOL_DESCRIPTORS: tuple[ToolDescriptor, ...] = (
    ...
    ToolDescriptor(
        ...
        category="filesystem",
        callable_path="fleet_rlm.runtime.tools.sandbox_filesystem:_sandbox_list_files_impl",
        required_capabilities=["filesystem:read"],
        sandbox_required=True,
        risk_level="low",
    ),
    ToolDescriptor(
        ...
        category="filesystem",
        callable_path="fleet_rlm.runtime.tools.sandbox_filesystem:_sandbox_read_file_impl",
        required_capabilities=["filesystem:read"],
        sandbox_required=True,
        risk_level="low",
    ),
