...
```python
"premise, hypothesis -> entailment, explanation"
"claim, evidence -> verdict, reasoning, confidence"
"scenario, options -> best_option, pros, cons, reasoning"
"problem -> solution_steps, final_answer, verification"
```
