...
The existing live Phase 3 evidence is decisive: deleting a Daytona interpreter context did not contain a deliberately detached subprocess. A reusable Session Sandbox therefore cannot be promoted merely because the interpreter context is fresh.

## P1.1 - Reduce the native containment proof to one minimal provider test
...
## P1.2 - Test exactly one provider-supported process-tree containment mechanism
...
## P1.3 - If native context containment fails, compare the two real fallbacks
...
## P1.4 - Record the production execution decision
...
**Phase 1 exit:** containment decision made. No Phase 2 deletion begins before this decision.
