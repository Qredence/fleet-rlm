...
12. [Maintainability freeze](how-to-guides/maintainability-freeze.md)
13. [P35-D callback observability decision](how-to-guides/p35d-callback-observability-decision.md)
14. [P36 ownership and deletion contract](how-to-guides/p36-ownership-deletion-inventory.md)
15. [P41 behavior freeze](reference/behavior-freeze.md)
16. [P42 Session-state behavior freeze](reference/p42-session-state-behavior-freeze.md)
17. [P42 module-subtraction ledger](reference/p42-module-subtraction-ledger.md)
18. [Session-scoped RLM state ADR](decisions/ADR-session-scoped-rlm-state.md)
