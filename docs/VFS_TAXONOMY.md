# VFS Taxonomy/Topology for fleet-rlm Modal Sandbox

This document defines the Virtual File System (VFS) taxonomy and topology for the `fleet-rlm` Modal Sandbox environment. This structure ensures consistency across various RLM tasks, provides clear separation between persistent and ephemeral data, and simplifies resource management.
