...
| `DATABASE_ADMIN_URL` | environment / consumer default | `integrations/config/env_file.py,api/runtime_services/settings.py,api/config.py,integrations/database/engine.py` | no | preserve during migration |
| `DATABASE_URL` | environment / consumer default | `integrations/daytona/errors.py,integrations/config/process.py,integrations/config/env_file.py,integrations/daytona/bridge.py,integrations/database/engine.py,integrations/daytona/isolation.py,api/config.py,api/bootstrap.py,api/runtime_services/settings.py` | no | preserve during migration |
...
| `USER` | environment / consumer default | `skills/install.py,skills/permissions.py,utils/sandbox_ownership.py,cli/runners.py,skills/schemas.py,skills/writes.py,integrations/database/repository_memory.py,skills/catalog.py,skills/validator.py,integrations/database/models_enums.py,integrations/observability/mlflow_runtime.py,api/runtime_services/session_persistence.py,api/config.py,integrations/observability/config.py,api/routers/skills.py,api/routers/skills_install.py,api/routers/skills_write.py` | no | preserve during migration |
