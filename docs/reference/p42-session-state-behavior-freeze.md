...
| Child isolation | Native child RLMs use fresh child RLM/interpreter/Sandbox state and never share mutable Root interpreter globals. | `tests/unit/backend/rlm/test_recursion_isolation.py`, `tests/unit/backend/rlm/test_recursion_session_snapshot.py`, live child lanes |
