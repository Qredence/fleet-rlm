...
- Database package ownership was cleaned in
  [Phase 8.5](../08.5-persistence-db/README.md) (`src/fleet_rlm/db/`;
  `integrations/database` removed). Phase 10 does not own further DB shim work.
