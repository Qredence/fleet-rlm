...
6. [Phase 6 — Observability](phases/06-observability/README.md) — in progress, uncommitted.
...
- After status changes, run `make plans-canvas-sync` and `make plans-canvas-check`.
