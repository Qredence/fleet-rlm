...
| --- | --- | --- |
| Turn stream, terminal ordering, and final cleanup | `chat/turn_runtime.py` (`turn_coordinator.py` compatibility shim) | TurnRuntime/coordinator stream contract suites |
