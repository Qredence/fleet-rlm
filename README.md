...
These methods return an [`APIResponse`](https://github.com/Qredence/fleet-rlm/tree/main/src/fleet_rlm_typescript_sdk/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/Qredence/fleet-rlm/tree/main/src/fleet_rlm_typescript_sdk/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/Qredence/fleet-rlm/issues) with questions, bugs, or suggestions.
