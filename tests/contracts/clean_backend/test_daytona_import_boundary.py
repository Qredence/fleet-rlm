"""K-003: Daytona SDK import boundary for fleet_rlm_clean."""
...
PACKAGE_ROOT = Path(__file__).resolve().parents[3] / "src" / "fleet_rlm_clean"
...
def test_build_daytona_client_is_lazy() -> None:
    ...
    import fleet_rlm_clean.daytona.client as client_module
