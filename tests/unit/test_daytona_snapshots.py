"""Tests for ``fleet_rlm.integrations.providers.daytona.snapshots``."""
...
from fleet_rlm.integrations.providers.daytona.snapshots import (
    alist_snapshots,
    aget_snapshot,
    aresolve_snapshot,
)
...
def test_alist_snapshots_returns_summaries(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "fleet_rlm.integrations.providers.daytona.snapshots._build_daytona_client",
