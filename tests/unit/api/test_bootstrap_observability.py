...
# ===========================================================================
# MLflow runtime service initialization
# ===========================================================================
@pytest.mark.asyncio
...
def test_emit_posthog_startup_event_returns_false_without_client(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setattr(
    ...
    emitted = emit_posthog_startup_event(
        app_env="local",
        auth_mode="dev",
...
def test_emit_posthog_startup_event_captures_event(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_emit_posthog_startup_event_handles_capture_error(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
