...
| --- | --- | --- | --- | --- |
| Phase 0 | `phase-0` | In Review | `QRE-321` | Codex multi-agent bootstrap, runbooks, docs, Playwright smoke baseline ([PR #74](https://github.com/Qredence/fleet-rlm/pull/74)) |
