...
How will you know your skill is working? These are aspirational targets - rough benchmarks rather than precise thresholds. Aim for rigor but accept that there will be an element of vibes-based assessment. We are actively developing more robust measurement guidance and tooling.
...
**Solution:** Add more description and nuance to the description - this may include keywords particularly for technical terms
