...
def check_activation(query: str, description: str) -> bool:
    ...
    trigger_keywords = [
        'large file', 'log analysis', '100K lines', 'big data',
        'massive', 'voluminous', 'long transcript', 'context overflow',
        'map-reduce', 'chunk processing', 'documentation dump'
    ]
    ...
    size_patterns = [
        r'\d+MB', r'\d+GB', r'\d+K lines', r'\d+K lines',
        r'large', r'massive', r'huge', r'big'
    ]
